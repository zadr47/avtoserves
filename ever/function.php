<?php 
	...
	define('path_to_unauthorized_page', '/unauthorized/unauthorized.php');
	define('path_to_authorization_page', '/unauthorized/authorization/authorization.php');
	define('path_to_checkin_page', '/unauthorized/checkin/checkin.php');

	define('path_to_authorized_page', '/authorized/avtoservis.php');

	define('path_to_restore_password_page', '/restore_password/restore_password.php');
